...
public class ControllerAdvice {
    ...
    @ExceptionHandler(exception = {StoredPointSearchException.class, VectorSavingException.class})
    public ResponseEntity<?> exceptionHandlerVectorHandler(Exception e){
